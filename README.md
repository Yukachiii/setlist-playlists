...
Apple Music・Amazon Music向けのプレイリストはSoundiizを経由して作成します。ボタンを押すと公開済み公演JSONから曲名・アーティスト名をSoundiizへ直接送り、24時間有効な移行画面を開きます。SpotifyプレイリストURLのコピーや貼り付けは不要です。移行先サービスの認証情報は当サイトでは扱いません。
