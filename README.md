...
予習プレイリストは、終了済みの最新ナンバリング公演の日付を基準にします。管理画面の「予習プレイリスト」でシリーズを選び、既存曲から抽出したSpotifyアーティスト候補を確認してから新曲を更新してください。Spotify上の全作品を確認し、同じISRCのシングル版・アルバム再収録を同一音源としてまとめ、最初の配信日が基準日より後の曲だけを保存します。公開後は訪問ページからSpotify、Apple Music、Amazon Music向けに作成できます。
